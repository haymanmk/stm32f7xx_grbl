...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOF, USER_OUTPUT_0_Pin|USER_OUTPUT_1_Pin|USER_OUTPUT_2_Pin|USER_OUTPUT_3_Pin
                          |STEP_DISABLE_Pin|COOLANT_Pin|SPINDLE_ENABLE_Pin|SPINDLE_DIR_Pin, GPIO_PIN_SET);
